...
gcloud compute ssh "jupyter@${INSTANCE_NAME}" -- "pip3 uninstall -y share_nb"
gcloud compute ssh "jupyter@${INSTANCE_NAME}" -- "pip3 uninstall -y share"
gcloud compute ssh "jupyter@${INSTANCE_NAME}" -- "pip3 install /home/jupyter/share"
